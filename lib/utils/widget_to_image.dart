...
class WidgetToImage {
  ...
  static Future<File?> captureAndSaveWidgetAsImage({
    ...
    final imageBytes = await captureWidgetAsImage(globalKey: globalKey, pixelRatio: pixelRatio);

    if (imageBytes != null) {
      return await saveImageToFile(imageBytes: imageBytes, fileName: fileName);
    }
